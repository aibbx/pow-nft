...
const Hero = () => {
  return (
    <div className="relative min-h-screen flex items-center pt-20 overflow-hidden">
      {/* Luxury background elements - enhanced with more elegant particles */}
      ...
      <div className="container mx-auto px-4 md:px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 py-12">
        ...
        >
          ...
          {/* Exclusive Features - Enhanced with more luxurious styling */}
          <motion.div 
...
const NFTCardVisualization = () => {
  return (
    <div className="relative w-full max-w-md mx-auto">
      ...
      <div className="absolute -inset-8 bg-wealth-gold/10 opacity-30 blur-2xl rounded-full animate-pulse delay-300" />
      
      {/* Floating particles - more luxurious with gold tint */}
      <motion.div 
        className="absolute -top-10 -right-10 h-5 w-5 rounded-full bg-wealth-gold/40 blur-sm"
        animate={{ y: [0, -10, 0], opacity: [0.3, 0.8, 0.3] }}
        transition={{ duration: 4, repeat: Infinity, ease: "easeInOut" }}
      />
      <motion.div 
        className="absolute bottom-10 -left-5 h-3 w-3 rounded-full bg-wealth-gold/40 blur-sm"
      ...
      {/* Card frame with enhanced shadow and animation */}
      <motion.div 
      ...
      >
        ...
        <div className="aspect-[3/4] bg-wealth-light p-6 border border-wealth-gold/40 relative">
          ...
          <div className="h-full flex flex-col">
            ...
            <div className="flex justify-between items-start mb-4">
              <div>
                ...
                <div className="text-xl font-display font-bold bg-clip-text text-transparent bg-gold-gradient">Legendary NFT</div>
              </div>
            ...
            <div className="mt-6">
              ...
              <div className="flex justify-between text-sm">
                ...
                <span className="font-bold bg-clip-text text-transparent bg-gold-gradient">100,000,000 USDT</span>
              </div>
            </div>
          </div>
        </div>
